  ...
  return (
    <>
      <header className="bg-[#0B0D10]">
        <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-">
          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                className="block rounded bg-[#66FCF2] p-2.5 text-gray-600 transition hover:text-gray-600/75 :hidden"
              >
